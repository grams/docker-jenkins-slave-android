...
RUN sudo -u jenkins -i /bin/bash -c "( sleep 5 && while [ 1 ]; do sleep 1; echo y; done ) | /usr/lib/android-sdk/tools/android update sdk --no-ui --filter 1,2,3,5,7,8,9,10,11,12,33,34,38,39,46,48"
